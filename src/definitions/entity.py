...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    "player": {
        ...
        "animations": {
            ...
            "shoot-left": {
                ...
                "interval": 0.05,
                "loops": 1,
                "texture": "character-shooting-arrow",
            },
            "shoot-right": {
                "frames": [9, 10, 11, 12],
                "interval": 0.05,
    ...
    "boss": {
        "texture": "boss",
        "animations": {
            "walk-left": {"frames": [4,5,6,5], "interval": 0.2, "texture": "boss"},
            "walk-right": {"frames": [7,8,9,8], "interval": 0.2, "texture": "boss"},
            "walk-down": {"frames": [1,2,3,2], "interval": 0.2, "texture": "boss"},
            "walk-up": {"frames": [10,11,12,11], "interval": 0.2, "texture": "boss"},
